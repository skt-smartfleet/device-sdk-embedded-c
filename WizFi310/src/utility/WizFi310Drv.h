...
typedef enum { //tested by tom
    MQ_CONNECTED =0,
    MQ_CONNECT_FAILED,
    MQ_DISCONNECTED,
	MQ_SUB_OK,
	MQ_SUB_FAILED,
	MQ_CONNTECTED_THINGPLUG,
	MQ_CONNTECTED_THINGPLUG_FAILED,
	MQ_CREATE_DEVICE_OK,
	MQ_CREATE_DEVICE_FAILED,
	MQ_DELETE_DEVICE_OK,
	MQ_DELETE_DEVICE_FAILED,
	MQ_CREATE_CONTAINER_OK,
	MQ_CREATE_CONTAINER_FAILED,
	MQ_DELETE_CONTATINER_OK,
	MQ_DELETE_CONTATINER_FAILED,
	MQ_SEND_TO_THINGPLUG_OK,
	MQ_SEND_TO_THINGPLUG_FAILED,
	MQ_REGISTER_CMD_OK,
	MQ_REGISTER_CMD_FAILED,
	MQ_DELETE_CMD_OK,
	MQ_DELETE_CMD_FAILED,
	MQ_CMD_RESILT_OK,
	MQ_CMD_RESILT_FAILED,
} mqtt_status_t;
...
private:
	...
	////////////////////////////////////////////////////////////////////////////
    // MQTT functions     ///tested by tom 17.09.20
    ////////////////////////////////////////////////////////////////////////////
	
	static int   mqttSet      (const char *username, const char *passphrase, const char *clientid, int alivetime); //tested by tom 17.09.18
	static int   mqttConnect  (IPAddress ip);
	static int   mqttSub      (const char *topic);
	
	////////////////////////////////////////////////////////////////////////////
	// SKT ThungPlug functions    //tested by tom 17.09.20
	////////////////////////////////////////////////////////////////////////////
	
	static int   connectThingPlug(int keepalive, const char *thingplugID, const char *credentialID, const char *serviceID, const char *deviceID);
	static int   createDevice(const char *deviceID);
	static int   deleteDevice(const char *deviceID, const char *serviceAE);
	static int   createContainer(const char *contatiner);
	static int   deleteContainer(const char *contatiner);
	static int   send(const char *contatiner, const char *data);
	static int   createCommand(const char *cmd);
	static int   deleteCommand(const char *cmd);
	static int   commandResult(const char *cmd, int exs, int exr);
